...
router.post("/login", (req, res, next) => {
	...
	}) (req, res)//passport.authenticate will return a function, hence the need for these parameters
	//the above req & res parameters will receive the req and res objects from the route handler
})
